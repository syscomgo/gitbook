...
## 1.1.6.0 Ver (預定時程2022-10-17)

* 公告 - 新增公告功能&#x20;
* 報表 - 修正「靜態表單」無法正確產生報表之問題&#x20;
* 報表 - 修正當表單有相同名稱欄位時，若設定「全部欄位」時只會顯示其中一欄位之問題&#x20;
* 報表 - 修正欄位設定時沒有「狀態」選項之問題
* 報表 - 條件設定追加「包含、不包含」&#x20;
* 報表 - 顯示欄位新增「流程關卡」選項&#x20;
* 登入 - 不再支援IE瀏覽器&#x20;
...
* 儀錶板 - 新增「匯出、匯入」功能&#x20;
* 手機APP - 修正「子查詢」未正確回填「下拉式選單」之問題&#x20;
* 手機APP - 修正「子查詢」未觸發動態條件之問題&#x20;
* 一般表單 - 表單列表介面上新增「匯出、匯入」功能 人員管理 - 現在也可以將部門納入角色中 介面調整 - 移除右上角「旗幟」顯示&#x20;
...
* 表單設計 - 新增「欄位複製」功能&#x20;
* 表單設計 - 隱藏「日期」欄位的「民國年」功能 表單設計 - 欄位計算規則新增「欄位聯動」功能 表單設計 - 欄位計算規則新增複製功能&#x20;
...
* 收集器流程 - 修正「事件開單」設定時，若選擇「不等於」儲存後會變回「等於」之問題
* 使用者管理 - 預設組織的設定權限改為管理者權限 附加檔案維護 - 修正「關鍵字查詢」搜尋不到檔案之問題
