...
## Linuxバージョンのインストール <a href="linux-ban-ben-an-zhuang" id="linux-ban-ben-an-zhuang"></a>

### OMFLOWサーバーのインストールを開始する
...
### STEP2、Webサーバー/Apacheサーバーをインストールする <a href="di-er-bu-zhou-an-zhuang-wang-ye-si-fu-qi-apache-server" id="di-er-bu-zhou-an-zhuang-wang-ye-si-fu-qi-apache-server"></a>
...
### STEP3、mod\_WSGI をインストールする <a href="di-san-bu-zhou-an-zhuang-modwsgi" id="di-san-bu-zhou-an-zhuang-modwsgi"></a>

mod \_wsgiは、WebサーバーとPython言語用に定義されたWebアプリケーションまたはフレームワークとの間のシンプルで普遍的なインターフェースです。DjangoとApacheの間のブリッジです。
...
### STEP4、OMFLOWのPython実行環境を確立する <a href="di-si-bu-zhou-jian-li-omflow-de-python-zhi-hang-huan-jing" id="di-si-bu-zhou-jian-li-omflow-de-python-zhi-hang-huan-jing"></a>
...
### STEP6、OMFLOWフォルダーの解凍する <a href="di-liu-bu-zhou-jie-ya-suo-omflow-zi-liao-jia" id="di-liu-bu-zhou-jie-ya-suo-omflow-zi-liao-jia"></a>
