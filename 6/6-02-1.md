...
例えば、test_flow.omfは繁体字中国語で設計されたアプリケーションであり、既にOMFLOWの内蔵機能によって各言語の翻訳がアップロードされています。英語を用いる利用者がこのアプリケーションを利用する必要がある場合、プログラムで「デザイン」の言語を繁体字中国語から英語に変更することができます。
